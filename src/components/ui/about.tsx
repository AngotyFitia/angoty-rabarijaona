        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 self-center">
            ...
            <div className="flex flex-row gap-4 justify-center md:justify-start animate-fadeIn delay-600">
              ...
              <Button className="w-auto bg-transparent text-[#1a1a1a] border border-[#fffff] shadow-md hover:bg-[#f0f0f0] hover:text-[#000000] hover:translate-y-[-2px] transition-transform duration-300" onClick={() => setCvModalOpen(true)}>Download CV </Button>
            </div>
          </div>
