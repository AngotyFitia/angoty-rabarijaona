...
export default function Home() {
  return (
    <section
      id="home"
      className="min-h-screen w-full flex flex-col md:flex-row items-center justify-center gap-y-8 bg-[#ffffff] px-6 md:px-12 pt-10 md:pt-20"
    >
      {/* Image en premier sur mobile */}
      <div className="mt-2 md:mt-0 flex justify-center animate-zoomIn order-1 md:order-2 md:flex-1">
